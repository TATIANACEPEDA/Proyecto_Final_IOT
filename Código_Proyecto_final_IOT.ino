...
unsigned long channelID =  1580463;
const char * WriteAPIKey = "8WU7H1N1CLIG5RSR";
unsigned long tiempo = 0;
unsigned long tiempo2 = 0;
int periodo = 20000;

// defino variables del  ultrasonico
...
const char *mqtt_user = "32espmodul";
const char *mqtt_pass = "32espmodul";
const char *root_topic_subscribe = "Temperatura/moduloesp32";
const char *root_topic_publish = "Temperatura/moduloesp32";
const char *root_topic_tem = "Temperatura/moduloesp32";
const char *root_topic_tempubli = "Temperatura/moduloesp32";
const char *root_topic_hum = "Temperatura/moduloesp32";
const char *root_topic_humpubli = "Temperatura/moduloesp32";
...
const char* password =  "1118569804";
...
void loop() 
{
    ...
    if (!client.connected())         // si el cliente no se conecta entra
    {
      ...
      { 
        ...
        if(BOTON == 0) PUERTA ="CERRADA";       // son para escribir si esta abierta o cerrada la puerta segun el caso
        else PUERTA ="ABIERTA";
  ...
  { 
    ...
    datosSMTP.setSender("Tatiana_Cepeda", "electivaiotunisangil@gmail.com");     //coloca el nombre del que envia el mensaje y el correo electrónico
    ...
    datosSMTP.addRecipient("yeimy
    cepeda@unisangil.edu.co");   // aqui se envia el correo al destinatario     
